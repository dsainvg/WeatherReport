...
function width(){
    ...
    if (window.innerWidth < 1000 && butexist === 0) {
        ...
        hambur.innerHTML = `<button onclick="menu()" id="hamburger-menu-but">
                            <svg class="hamburger-menu-but" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF"><path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/></svg>
                            </button>`
